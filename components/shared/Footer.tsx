    ...
    <footer className="border-t bg-gray-50">
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
          ...
          <div>
            <div className="mb-4 flex items-center gap-2">
              ...
              />
              <h3 className="text-lg font-bold text-primary">YL Sport</h3>
            </div>
            <p className="text-sm text-gray-600">
              טייץ ספורט איכותי לנשים
              <br />
              נוחות וסטייל בכל אימון
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="mb-4 font-semibold">קישורים מהירים</h4>
          ...
          {/* Customer Service */}
          <div>
            <h4 className="mb-4 font-semibold">שירות לקוחות</h4>
            <ul className="space-y-2 text-sm">
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <a href="tel:+972508897290" className="hover:text-primary">
                  050-889-7290
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 border-t pt-8 text-center text-sm text-gray-600">
          <p>© {currentYear} YL Sport. כל הזכויות שמורות.</p>
        </div>
      </div>
    </footer>
  );
