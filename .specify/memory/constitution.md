...
**פלטת צבעים מחייבת**:
- **צבע ראשי (Primary)**: `#e87f93` (Pink - ורוד עז ואנרגטי)
  - Light: `#fce4e9` | Dark: `#d5617a`
- **צבע משני (Secondary)**: `#fce4e9` (Pink Light - לקופסאות ורקעים)
  - Light: `#fef3f6` | Dark: `#e87f93`
...
- **Contrast Ratio**: MUST > 4.5:1 לנגישות (WCAG AA)
