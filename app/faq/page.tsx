        ...
        answer: (
          <>
            ...
            <ul className="list-disc pr-4 space-y-1">
              <li>S: 40-42 (מותניים 63-70 ס&quot;מ)</li>
              <li>M: 44-46 (מותניים 71-78 ס&quot;מ)</li>
              <li>L: 48-50 (מותניים 79-86 ס&quot;מ)</li>
              <li>XL: 52-54 (מותניים 87-94 ס&quot;מ)</li>
            </ul>
            <p className="mt-2">
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "עלות המשלוח היא 30₪ לכל רחבי הארץ. בהזמנות מעל 500₪ המשלוח חינם! ניתן גם לבחור באיסוף עצמי חינם מנקודת האיסוף שלנו באר שבע (תוך 24-48 שעות).",
      },
      {
